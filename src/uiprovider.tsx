...
export let colorModeQuery =
	typeof window !== "undefined"
		? window.matchMedia("(prefers-color-scheme: dark)")
		: undefined;

export let UIProvider = (
	...
	let { not, and, on, or, styleSheet } = useRef(
		createHooks(...new Set<Selector>([...Object.values(selectors)])),
	).current;
