...
export default {
	...
	span: (props: BoxProps<"span">) => createElement(Box, { as: "span", ...props }),
	strong: (props: BoxProps<"strong">) => createElement(Box, { as: "strong", ...props }),
	em: (props: BoxProps<"em">) => createElement(Box, { as: "em", ...props }),
	abbr: (props: BoxProps<"abbr">) => createElement(Box, { as: "abbr", ...props }),
	...
	address: (props: BoxProps<"address">) => createElement(Box, { as: "address", ...props }),
	blockquote: (props: BoxProps<"blockquote">) => createElement(Box, { as: "blockquote", ...props }),
	footer: (props: BoxProps<"footer">) => createElement(Box, { as: "footer", ...props }),
	section: (props: BoxProps<"section">) => createElement(Box, { as: "section", ...props }),
	article: (props: BoxProps<"article">) => createElement(Box, { as: "article", ...props }),
	aside: (props: BoxProps<"aside">) => createElement(Box, { as: "aside", ...props }),
	nav: (props: BoxProps<"nav">) => createElement(Box, { as: "nav", ...props }),
	main: (props: BoxProps<"main">) => createElement(Box, { as: "main", ...props }),
	figure: (props: BoxProps<"figure">) => createElement(Box, { as: "figure", ...props }),
	figcaption: (props: BoxProps<"figcaption">) => createElement(Box, { as: "figcaption", ...props }),
	details: (props: BoxProps<"details">) => createElement(Box, { as: "details", ...props }),
	summary: (props: BoxProps<"summary">) => createElement(Box, { as: "summary", ...props }),
	time: (props: BoxProps<"time">) => createElement(Box, { as: "time", ...props }),
	...
	small: (props: BoxProps<"small">) => createElement(Box, { as: "small", ...props }),
	mark: (props: BoxProps<"mark">) => createElement(Box, { as: "mark", ...props }),
